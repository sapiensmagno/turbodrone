...
# After refactoring this script simply runs the main application
# All the UI and functionality is now handled by e88_qt.app
# This file is kept for backward compatibility and simple execution
# It provides a simple way to run the application without needing to import from e88_qt.app directly
if __name__ == "__main__":
    from pathlib import Path

    sys.path.insert(0, str(Path(__file__).resolve().parent))

    from e88_qt.app import main
